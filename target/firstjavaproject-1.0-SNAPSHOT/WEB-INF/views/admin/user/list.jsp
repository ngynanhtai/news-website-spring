                        ...
                        <div class="col-xs-12">
                            <div class="widget-box table-filter">
                                ...
                                <div class="dt-buttons">
                                    <button id="btnDelete" type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold pull-right" data-toggle="tooltip" title="Xoá">
                                        <span>
                                    ...
                                    <a flag="info"
                                       ...
                                       title="Thêm người dùng" href="<c:url value='/admin/user-edit'/>">
                                        <span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Cập nhật bài viết" href='<c:url value='/admin/user-edit?id=${item.id}'/>'>
...
<script>
    ...
    $(function(){
        ...
        $('#roleCode').on('change', function () {
            var dropdownRoleVal = $('#roleCode').val();

            var url = $(this).val();
            if (url) {
                if (dropdownRoleVal === "all") {
                    window.location = "${UserLIST}?page=1&limit=5";
                }
                else {
                    window.location = "${UserLIST}?page=1&limit=5&sortList="+dropdownRoleVal;
                }
            }
        });
    });
    ...
    function deleteUser(ids) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${UserLIST}?page=1&limit=5&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${UserLIST}?page=1&limit=5&message=error_system";
            }
        });
    };
