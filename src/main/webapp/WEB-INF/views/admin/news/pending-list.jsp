...
<html>
<head>
    <title>Bài viết chờ xử lý</title>
</head>
<body>
    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Bài viết chờ xử lý</li>
            </ul><!-- /.breadcrumb -->
        </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title">ACTIVATE NEWS</h5>
                                </div>
                                <div class="modal-body">
                                    <p>Are you sure that you want to activate this news ?</p>
                                </div>
                                <div class="modal-footer">
                                    <button style="background-color: green;" type="button" id="btnConfirmUpdateStatus" class="btn btn-primary">ACTIVATE</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 120px;">
                                                    <div style="display: flex; flex-direction: row; background-color: white !important;">
                                                        ...
                                                        <div style="flex: 1;">
                                                            <a style="margin: 5px; width: 39px; background-color: green !important; border-color: green !important;" class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                               title="Activate" href='javascript:void(0)' onclick="ActivatePendingNews(${item.id})">
        ...
        $('#categoryCode').on('change', function () {
            ...
            if (url) {
                if (dropdownRoleVal === "all") {
                    window.location = "${PendingNewsLIST}?page=1";
                }
                else {
                    window.location = "${PendingNewsLIST}?page=1&sortList="+dropdownRoleVal;
                }
            }
        });
    });

    function ActivatePendingNews(id) {
        var data = {};
        data["id"] = id;
        data["status"] = true;
    ...
    function updateStatus(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${PendingNewsLIST}?page=1&message=update_success";
            },
            error: function (error) {
                window.location.href = "${PendingNewsLIST}?page=1&message=error_system";
            }
        });
    }
</script>
